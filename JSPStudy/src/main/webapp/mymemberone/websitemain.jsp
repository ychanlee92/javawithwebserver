	...
	<div>
		...
		<nav>
			<div id="divNav">
				<div id="navDiv">
					...
					<div id="divNavRight">
						<!-- 로그인 & 회원가입 창 띄우기 -->
						<a class="divNavRightA" href="login.html" target="sectionIframe"><b>로그인</b></a>
						<a class="divNavRightA" href="signup.html" target="sectionIframe"><b>회원가입</b></a>
					</div>
					<%
					}
					%>
		...
		<section>
			<div id="divSection">
				...
				<div id="divIframe">
					<iframe src="mainsection.jsp" width="100%" height="100%"
						name="sectionIframe" frameborder="0"> </iframe>
				</div>
			</div>
		</section>
		<!-- 어사이드 -->
