	...
	<div id="divSection">
		<div>
			<img src="source/1.jpg" alt="사진1"
				onclick="call_confirm(this.src,'1.jpg')" /> <img src="source/3.jpg"
				alt="사진2" onclick="call_confirm(this.src,'3.jpg')" /> <img
				src="source/4.jpg" alt="사진3"
				onclick="call_confirm(this.src,'4.jpg')" />
		</div>
		<div>
			<img src="source/5.jpg" alt="사진4"
				onclick="call_confirm(this.src,'5.jpg')" /> <img src="source/6.jpg"
				alt="사진5" onclick="call_confirm(this.src,'6.jpg')" /> <img
